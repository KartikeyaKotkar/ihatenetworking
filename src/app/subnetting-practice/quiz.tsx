...
import { subnetQuestion } from "@/lib/learn";
...
export default function Quiz() {
  const [q, setQ] = useState<Question>(() => subnetQuestion());
  ...
  function check(): void {
    ...
    posthog.capture("quiz_answer_checked", { quiz: "subnetting", correct: isCorrect });
  }
  ...
  function reset(): void {
    posthog.capture("quiz_reset", { quiz: "subnetting", score, total });
    setScore(0);
    setTotal(0);
    setQ(subnetQuestion());
    setPicked(null);
